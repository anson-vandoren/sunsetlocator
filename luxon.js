  ...
  */
  ...
  function formatOffset(offset, format) {
    ...
    switch (format) {
      case "short":
        return (
          "" + sign + padStart(Math.abs(hours), 2) + ":" + padStart(minutes, 2)
        );
  ...
  var Duration =
    ...
    (function() {
      ...
      _proto.shiftTo = function shiftTo() {
        ...
        for (
          var _i2 = 0, _orderedUnits2 = orderedUnits;
          _i2 < _orderedUnits2.length;
          _i2++
        ) {
      ...
      _proto.equals = function equals(other) {
        ...
        for (
          var _i4 = 0, _orderedUnits3 = orderedUnits;
          _i4 < _orderedUnits3.length;
          _i4++
        ) {
  ...
  function quickDT(obj, zone) {
    ...
    for (
      var _i = 0, _orderedUnits = orderedUnits$1;
      _i < _orderedUnits.length;
      _i++
    ) {
    ...
    (function() {
      ...
      DateTime.fromMillis = function fromMillis(milliseconds, options) {
        ...
        if (!isNumber(milliseconds)) {
          throw new InvalidArgumentError(
            "fromMillis requires a numerical input"
          );
      ...
      _proto.setZone = function setZone(zone, _temp) {
        var _ref5 = _temp === void 0 ? {} : _temp,
          ...
          keepLocalTime =
            _ref5$keepLocalTime === void 0 ? false : _ref5$keepLocalTime,
          _ref5$keepCalendarTim = _ref5.keepCalendarTime,
          keepCalendarTime =
            _ref5$keepCalendarTim === void 0 ? false : _ref5$keepCalendarTim;
    ...
    */
      ...
      _proto.toSQLTime = function toSQLTime(_temp4) {
        var _ref8 = _temp4 === void 0 ? {} : _temp4,
          ...
          includeZone =
            _ref8$includeZone === void 0 ? false : _ref8$includeZone;
